...
exports.search = function(req, res) {
    ...
    var cacheKey = (query.toLowerCase()+index.toLowerCase()+onlyAmazon.toString()).replace(/ /g, '');

    if ((typeof node === 'undefined') && (typeof brand === 'undefined') && cache.get(cacheKey) !== null) {
    ...
    function callWithOptions(options) {
        ...
        prodAdv.call("ItemSearch", options, function(err, result) {
            ...
            if (ajaxCalls >= ajaxCallsMax) {
                ...
                if (typeof node === 'undefined' && typeof brand === 'undefined') {
                    cache.put(cacheKey, response, 5*60*60*1000); // 5 hours
                }
                res.json(response);
            }
        });
