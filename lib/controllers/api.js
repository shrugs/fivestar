...
function replacePriceAndImg(item) {
    ...
    if (item.ItemAttributes.ListPrice === undefined) {
        ...
        prodAdv.call("ItemLookup", {
                ...
                for (var i = 0; i < itemResult.Items.Item.length; i++) {
                    ...
                    for (var j = keys.length; j >=0; j--) {
                        ...
                        if ((itemResult.Items.Item[i].OfferSummary.LowestNewPrice !== undefined) && (parseInt(itemResult.Items.Item[i].OfferSummary.LowestNewPrice.Amount, 10) > k)) {
