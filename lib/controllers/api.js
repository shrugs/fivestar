...
// @TODO(shrugs) - promise-ify this garbage code
...
function standardizeFeatures(item) {
...
exports.search = function(req, res) {
    ...
    var maxProductsPerBucket = platform === 'app' ? 4 : 10;
    ...
    function getResultsForItems(itemIDs, idx) {
        prodAdv.call("ItemLookup", {
                ...
                for (var i = 0; i < itemResult.Items.Item.length; i++) {
                    itemResult.Items.Item[i] = standardizeFeatures(replacePrice(itemResult.Items.Item[i]));
